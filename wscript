...
def configure(conf):
  ...
  # flags = ['-Wall', '-D_FILE_OFFSET_BITS=64', '-D_LARGEFILE_SOURCE', '-D_CANVAS_NODE_MODULE', '-D_GLIBCXX_DEBUG'] # debug flags  
  flags = ['-O3', '-Wall', '-D_FILE_OFFSET_BITS=64', '-D_LARGEFILE_SOURCE', '-D_CANVAS_NODE_MODULE']
